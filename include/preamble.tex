...
\hypersetup{
  ...
  pdfauthor={Julius Gummersbach, 3516621},
  pdfsubject={Matchings und Knotenüberdeckung : Zweiter Teil des Beweises des Satzes von König},
  colorlinks=true,
  linkcolor=midblue,
  citecolor=midgreen,
  urlcolor=midred
